...
<form class="form-horizontal" method="post" onsubmit="return cekform();" action="<?php echo base_url(); ?>Santri/simpan">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Juz</label>

		<div class="col-sm-9">
			<input type="text" id="juz" placeholder="juz" name="juz" class="col-xs-10 col-sm-5"/>
		</div>
	</div>
