...
<form class="form-horizontal" method="post" onsubmit="return cekform();" action="<?php echo base_url(); ?>Ustadz/simpan">
	...
	<div class="form-group">
		...
		<div class="col-sm-9">
			<a href="<?php echo base_url();?>assets/avatars/handdrawn_vector_114.jpg" title=" Gambar : <?php echo $this->session->userdata('username'); ?>" data-rel="colorbox">
				<img width="100" height="50" alt="150x150" src="<?php echo base_url();?>assets/avatars/handdrawn_vector_114.jpg" />
			</a>
		</div>
	</div>
