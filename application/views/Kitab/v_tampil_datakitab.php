		...
		<tr>
				...
				as $key) 
			{
				...
				<td>
					...
					<a href="<?php echo base_url();?>Kitab/delete/<?php echo $key->kode_pelajaran;?>" onclick="return confirm('Anda Yakin ingin menghapus data ini ???');" title="Hapus Data" class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>Delete</a>
				</td>
			</tr>
			<?php }?>		
		</tbody>
