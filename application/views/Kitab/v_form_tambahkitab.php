...
<form class="form-horizontal" method="post" onsubmit="return cekform();" action="<?php echo base_url(); ?>Kitab/simpan">
	...
	<div class="form-group">
		<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> Jus</label>

		<div class="col-sm-7">
			<input type="text" id="kitab" placeholder="Mata Pelajaran" name="kitab" class="col-xs-10 col-sm-5"/>
		</div>
	</div>
